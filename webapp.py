...
with col1:
    texto1 = st.text_area("Texto 1", height=300, key="texto1", value=st.session_state.texto1)

with col2:
    texto2 = st.text_area("Texto 2", height=300, key="texto2", value=st.session_state.texto2)
...
st.text_area("Resultado", st.session_state.resultado, height=400, key="resultado_final")
